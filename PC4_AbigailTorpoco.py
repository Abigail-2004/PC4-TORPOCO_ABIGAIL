...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>Blog de Abigail</h1>", unsafe_allow_html=True)
    ...
    col1.image("foto_perfil.webp", caption='fotooo', width=300)
    ...
    texto_2 = """
    Al principio se me hizo un poco díficil pues no entendía muy bien acerca de informatica o computadoras.
    La programación me enseño que no es tan fácil crear páginas, blogs y usar códigos.
    La parte que más me gusta es crear imagenes.
    Probablemente use la programación para crear blogs o páginas con mis temas preferidos.
    """
    ...
    st.markdown("<h2 style='text-align: center;'>Aquí abajo debe haber un video 📹</h2>", unsafe_allow_html=True)
    ...
    st.markdown(f"<div style='text-align: center;'><a href='https://drive.google.com/file/d/1Ym753Xcue9L9R1iFaye5gjUEQToM8t5N/view?usp=sharing' target='_blank'><button>Dame clic, soy el video :b</button></a></div>", unsafe_allow_html=True) 
    ...
    if grafico_seleccionado == 'Gráfico de barras de equipos de futbol':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Esto es un gráfico de barras promedio de partidos de fútbol. Fue extraído a partir de los resultados de partidos de fútbol de la liga.</div>", unsafe_allow_html=True)
        st.image("pc_barras_1.png", caption='Gráfico de barras', width=500)
        pass
    elif grafico_seleccionado == 'Gráfico de barras de pastel de los resultados de Barcelona como local':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Esto es un gráfico de barras. Fue extraído a partir de los partidos de Barcelona como equipo local.</div>", unsafe_allow_html=True)
        st.image("pc_pie_1.png", caption='Gráfico de pastel', width=500)
        pass
    elif grafico_seleccionado == 'Gráfico de nube de palabras de discurso':
